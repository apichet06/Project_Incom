...
--
-- Host: localhost
-- Generation Time: Sep 27, 2021 at 04:43 PM
...
INSERT INTO `new_order` (`n_id`, `n_customerStatus`, `n_datejob`, `n_number`, `n_specstatus`, `n_lot`, `c_id`, `customer_id`, `pa_id`, `pa_name`, `n_admissiondate`, `n_desired`, `n_line`, `n_znfe`, `n_lathe`, `n_baking`, `n_product_safety`, `n_white_rust`, `n_red_rust`, `n_customeritem`, `n_item`, `n_producgroup`, `n_producgroupother`, `n_automotivetype`, `n_carcamp`, `n_workgroup`, `n_weight`, `n_madel`, `n_remark`, `n_volume`, `n_amount_mk`, `n_amount_mitem`, `n_amount_yk`, `n_amount_yitem`, `n_thickness`, `n_thickness_other`, `n_examine`, `n_examine_percen`, `n_nuantity_input`, `n_itemk`, `n_container`, `n_box`, `n_boxk`, `n_itembag`, `n_inout_procuct`, `n_inout_other`, `n_open_fly`, `n_open_flythink`, `n_bin_number`, `n_userbin_name`, `n_bindate`, `n_approve_data`, `n_id_ecacc`, `n_user_approve`, `n_approve_date`, `n_nuote_nuote`, `n_bid_date`) VALUES
(1, 'ลูกค้าใหม่', '2021-09-27', '1', 'ชั่วคราว', ' Lot NO.', 1, 'xxxx1', 67, 'dfg', '2021-09-27', '2021-09-30', 'RA', 'ZnFe', 'กลึง', 'No', 'ความปลอดภัยด้านผลิตภัณฑ์(ถ้ามี)', 'สนิมขาว', 'สนิมแดง', 'ลูกค้าต้องการ', 'ชิ้น', 'Screw_Bolt', 'อื่นๆ', 'ยานยนต์ประเภท', 'ค่ายรถ', '4ล้อ', 'grum', 'ปี', 'จุดระวังพิเศษ', '', 'กก.', 'ชิ้น', 'กก.', 'ชิ้น', 'ไม่กำหนดจุดวัด', 'กำหนดจุดวัดระบุbox', 'ตรวจสอบ100', '%', '', '', '', 'บรรจุตามมาตรฐานของลูกค้า', 'กก ชิ้น', 'ชิ้น', 'ลูกค้า', 'อื่นๆ  ', 'บิลชั่วคราว', 'คิดเหมา  ', '350', 'อออ', '2021-09-27', 'อนุมัติเพิ่มในฐานระบบ', 'รหัสสินค้าในระบบ ECACC', 0, '0000-00-00', 'อ้างอิงใบเสนอราคาเลขที่', '2021-09-28');
...
--
ALTER TABLE `new_order`
  MODIFY `n_id` int(11) NOT NULL AUTO_INCREMENT COMMENT 'รหัส', AUTO_INCREMENT=3;
